...
import { PhysicalStoreInfo } from './PhysicalStoreInfo'
  ...
  return (
    <S.Section id="presentes" ref={ref as never} $visible={isVisible}>
      <S.Inner>
        ...
        {/* Escolha do canal de compra: lista online vs. loja física */}
        <S.ChannelTabs role="tablist" aria-label="Como você quer nos presentear">
          <S.ChannelTab
            type="button"
            role="tab"
            $active={channel === 'online'}
            aria-selected={channel === 'online'}
        ...
        {channel === 'physical' && <PhysicalStoreInfo />}
